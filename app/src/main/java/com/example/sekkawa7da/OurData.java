...
public class OurData {
    ...
    public static String[] mUsernames = new String[]{
            "Mahmoud Refaie","Mahmoud Refaie","Mahmoud Refaie","Mahmoud Refaie","Mahmoud Refaie","Mahmoud Refaie"
    };
    public static String[] mDurations = new String[]{
            "3 mins ago","3 mins ago","3 mins ago","3 mins ago","3 mins ago","3 mins ago"
    };
    public static String[] mFromCity = new String[]{
            "Aswan","Aswan","Aswan","Aswan","Aswan","Aswan"
    };
    public static String[] mToCity = new String[]{
            "Assiut","Assiut","Assiut","Assiut","Assiut","Assiut"
    };
