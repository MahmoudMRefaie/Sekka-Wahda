...
public final class SplashScreenBinding implements ViewBinding {
  ...
  private SplashScreenBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView projectLogo,
      @NonNull TextView projectName) {
  ...
  public static SplashScreenBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.project_logo;
      ImageView projectLogo = ViewBindings.findChildViewById(rootView, id);
      if (projectLogo == null) {
        break missingId;
      }
      ...
      return new SplashScreenBinding((ConstraintLayout) rootView, projectLogo, projectName);
    }
