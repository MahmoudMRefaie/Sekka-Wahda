...
public final class NotificationItemBinding implements ViewBinding {
  ...
  private NotificationItemBinding(@NonNull CardView rootView, @NonNull TextView message,
      @NonNull CardView postCard) {
  ...
  public static NotificationItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NotificationItemBinding((CardView) rootView, message, postCard);
    }
