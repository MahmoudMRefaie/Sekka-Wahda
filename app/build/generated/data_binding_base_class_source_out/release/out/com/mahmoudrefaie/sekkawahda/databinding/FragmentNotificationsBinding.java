...
public final class FragmentNotificationsBinding implements ViewBinding {
  ...
  private FragmentNotificationsBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView notifications, @NonNull TextView text) {
  ...
  public static FragmentNotificationsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView notifications = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentNotificationsBinding((ConstraintLayout) rootView, notifications, text);
    }
